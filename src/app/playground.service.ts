...
export class PlaygroundService {
  get(): Promise<Playground[]> {
    var playgrounds: Playground[] = [
      ...
      { key: "slow-signin", route: "/slow-signin", title: "ล็อกอินตอบสนองช้าจัง", description: "ล็อกอินเหมือนเดิม เพิ่มเติมคือตอบสนองช้ามาก" },
      { key: "unstable-signin", route: "/unstable-signin", title: "ล็อกอินได้บ้างไม่ได้บ้าง", description: "API กากมาก ล็อกอินได้บ้างไม่ได้บ้าง" },
